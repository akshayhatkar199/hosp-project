...
const AboutUs = () => {
    ...
    const propsimage2 = {
        ...
        onRemove: (file) => {
            const index = fileList.indexOf(file);
            const newimage2FileList = fileList.slice();
            newimage2FileList.splice(index, 1);
            setFileList(newimage2FileList);
        },
        beforeUpload: (file) => {
            const isPNG = file.type === 'image/png' || file.type === 'image/jpeg' || file.type === 'image/jpg';
            // setPreview(undefined);
    ...
    const onFinishbannerslider = async (values) => {
        ...
        if (typeof id === 'undefined') {
            ...
            var filename2 = batmayadata.image2;
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12} lg={4} sm={12} xl={4}>
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: 'Please title1.'
                                        }
                                    ]}
                                >
                                    <TextArea row={2} name="title1" className="datepicinp textfont" placeholder={'Enter Title1'} />
                                </Form.Item>
                                <span className="textlabelbatmaya">
                                    About Title1<span className="text-danger">*</span>
                                </span>
                            </Grid>
                            <Grid item xs={12} lg={4} sm={12} xl={4}>
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: 'Please windowname.'
                                        }
                                    ]}
                                >
                                    <Input name="windowname" className="datepicinp textfont" placeholder={'Enter windowname'} />
                                </Form.Item>
                                <span className="textlabel">
                                    windowname<span className="text-danger">*</span>
                                </span>
                            </Grid>
                            <Grid item xs={12} lg={2} sm={12} xl={2}>
                                ...
                                <span className="textimagelabel">
                                    About image1<span className="text-danger">*</span>{' '}
                                </span>
                            </Grid>
                            <Grid item xs={12} lg={2} sm={12} xl={2}>
                                <Form.Item
                            ...
                            <Grid item xs={12} lg={4} sm={12} xl={4}>
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: 'Please Title2.'
                                        }
                                    ]}
                                >
                                    <TextArea row={2} name="title2" className="datepicinp textfont" placeholder={'Enter Title2'} />
                                </Form.Item>
                                <span className="textlabelbatmaya">
                                    About Title2<span className="text-danger">*</span>{' '}
                                </span>
                            </Grid>
                            <Grid item xs={12} lg={4} sm={12} xl={4}>
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: 'Please windowname2.'
                                        }
                                    ]}
                                >
                                    <Input name="windowname2" className="datepicinp textfont" placeholder={'Enter windowname2'} />
                                </Form.Item>
                                <span className="textlabel">
                                    windowname2<span className="text-danger">*</span>
                                </span>
                            </Grid>
                            <Grid item xs={12} lg={2} sm={12} xl={2}>
                                {id ? (
                                    <Form.Item name="image2">
                                        <Upload {...propsimage2} maxCount={1}>
                                            <Button className="buttonimge" icon={<UploadOutlined />}>
                                                Select File
                                            </Button>
                                        </Upload>
                                ...
                                <lable className="text-danger">{imgError}</lable>
                                <span className="textimagelabel">
                                    About image2<span className="text-danger">*</span>{' '}
                                </span>
                            </Grid>
