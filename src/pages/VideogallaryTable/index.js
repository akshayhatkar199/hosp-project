...
const VideogallaryTable = () => {
    // const conponentPDF = useRef();
    const [placement, SetPlacement] = useState('bottomRight');
    const [VideogallaryTableData, setVideogallaryTableData] = useState([]);
        ...
        // },
        {
            ...
            render: (_, record) => (
                <Space size="middle">
                    ...
                    <Link to={`/Videogallary/${record.id}`}>
    ...
    const handlePDF = () => {
        try {
            ...
            const tdata = VideogallaryTableData.map((elt) => [elt.batmyalable, elt.papername, elt.batmyadate]);
    ...
    //             setVideogallaryTableData(res.data.data);
    //             setloading(false);
    //         },
    //         (err) => {
    ...
    //                             }
    //                         });
    //                         setVideogallaryTableData(newData);
    ...
    return (
        <>
            <Typography variant="h5" className="mx-2">
                <small className="text-black-50">Home</small> {'/'} <b>Videogallary Table</b>
            </Typography>
            <br></br>
            <MainCard>
                <Grid container spacing={2} columnSpacing={{ sm: 1, md: 3 }}>
                    <Grid item lg={6} xs={6} sm={12} md={6}>
                        <span className="main-title bg-white text-dark ">
                            <b className="brandtaitletext">Videogallary Table</b>
                        </span>
                    </Grid>
                    <Grid item lg={6} xs={12} sm={12} md={6} className="text-end">
                        <Link to="/Videogallary">
                        ...
                        <Grid item lg={12} xs={12} sm={12} md={12}>
                            <div className="table-responsive">
                                <Table
                                    ...
                                    columns={columns}
                                    dataSource={VideogallaryTableData}
                                    size="small"
                                    id="excel"
                                    // bordered
...
export default VideogallaryTable;
