...
import { professiontablesearchByApi } from 'components/Helper/professionmaster';
...
const Professiontable = () => {
    ...
    const [ProfessiontableData, setProfessiontableData] = useState([]);
        ...
        // },
        {
            ...
            render: (_, record) => (
                <Space size="middle">
                    ...
                    <Link to={`/Professionfrom/${record.id}`}>
    ...
    const petientbyapi = (offset = 0, multiplesearchinput = '', current = null) => {
        ...
        professiontablesearchByApi(payloadData).then(
            async (res) => {
                console.log('res=>', res);
                ...
                setProfessiontableData(res.data.data);
                setloading(false);
            },
            (err) => {
    ...
    //                             }
    //                         });
    //                         setProfessiontableData(newData);
    ...
    return (
        <>
            <Typography variant="h5" className="mx-2">
                <small className="text-black-50">Home</small> {'/'} <b>Profeesion Details</b>
            </Typography>
            <br></br>
            <MainCard>
                <Grid container spacing={2} columnSpacing={{ sm: 1, md: 3 }}>
                    <Grid item lg={6} xs={6} sm={12} md={6}>
                        <span className="main-title bg-white text-dark ">
                            <b className="brandtaitletext">Profeesion Details</b>
                        </span>
                    </Grid>
                    <Grid item lg={6} xs={12} sm={12} md={6} className="text-end">
                        <Link to="/Professionfrom">
                        ...
                        <Grid item lg={12} xs={12} sm={12} md={12}>
                            <div className="table-responsive">
                                <Table
                                    ...
                                    columns={columns}
                                    dataSource={ProfessiontableData}
                                    size="small"
                                    id="excel"
                                    // bordered
