...
const Brandtable = () => {
    ...
    const columns = [
        ...
        {
            title: 'Enquiry PersonName',
            dataIndex: 'EnquiryPersonName',
            key: 'EnquiryPersonName'
        },
        {
    ...
    const petientbyapi = (offset = 0, multiplesearchinput = '', current = null) => {
        ...
        DetailListByApi(payloadData).then(
            async (res) => {
                console.log('res=>', res);
    ...
    return (
        <>
            <Typography variant="h5" className="mx-2">
                <small className="text-black-50">Home</small> {'/'} <b>Brand Details</b>
            </Typography>
            <br></br>
            <MainCard>
                <Grid container spacing={2} columnSpacing={{ sm: 1, md: 3 }}>
                    <Grid item lg={6} xs={6} sm={12} md={6}>
                        <span className="main-title bg-white text-dark ">
                            <b className="brandtaitletext">Brand Details</b>
                        </span>
                    </Grid>
