...
const Jumbotron = () => {
    ...
    const [Jumbotronloding, setJumbotronloding] = useState(false);
    const [JumbotronData, setJumbotronData] = useState(null);
    ...
    // console.log('JumbotronData', JumbotronData);
        ...
        batmayadetailsGetidByApi(id)
            .then(
                async (res) => {
                    ...
                    setJumbotronData(response);
                    setCheckbox(response.Checkbox);
                    console.log('response', response);
                    form.resetFields();
                    console.log('res', res);
                    // console.log(' response', response);
                    setJumbotronloding(false);
                },
                (err) => {
                    console.log('err', err);
                    setJumbotronloding(false);
    ...
    const onFinishbannerslider = async (values) => {
        ...
        if (typeof id === 'undefined') {
            ...
            var filename = JumbotronData.imagebatmaya;
            var filename2 = JumbotronData.image2;
                    ...
                    <Typography variant="body2">
                        <Grid container spacing={2}>
                            <Grid item xs={12} lg={4} sm={12} xl={4}>
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: 'Please Enter  Jumbotron Title.'
                                        }
                                    ]}
                                >
                                    <Input name="title" className="datepicinp textfont" placeholder={'Enter Title'} />
                                </Form.Item>
                            ...
                            <Grid item xs={12} lg={4} sm={12} xl={4}>
                                ...
                                >
                                    <Input name="address" className="datepicinp textfont" placeholder={'Enter Address'} />
                                </Form.Item>
                                <span className="textlabel">
                            ...
                            <Grid item xs={12} lg={4} sm={12} xl={4}>
                                {/* {id ? (
                                    JumbotronData && JumbotronData.imagebatmaya && JumbotronData.imagebatmaya != '' ? (
                                        <>
                                            <div>
                                                <img
                                                    src={URLidimage + JumbotronData.imagebatmaya}
                                                    alt=""
