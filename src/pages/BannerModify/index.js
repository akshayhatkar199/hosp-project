...
const BannerModify = () => {
    ...
    const [BannerModifyoffset, setBannerModifyoffset] = useState([]);
    // const [BannerModifyExcellsheetdata, setBannerModifyExcellsheetdata] = useState([]);
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: 'bannerStartDate',
            key: 'bannerStartDate'
        },
        {
            title: 'Banner End Date ',
            dataIndex: 'bannerEndDate',
            key: 'bannerEndDate'
        },
        {
            title: 'Actions',
    ...
    const onSearch = (e) => {
        ...
        BannerModifybyapidun(0, multiplesearchinput);
    };
    ...
    //     );
    // };
    const BannerModifybyapidun = (offset = 0, multiplesearchinput = '', current = null) => {
        setloading(true);
        setBannerModifyoffset(offset);
        let payloadData = {
            offset: offset,
            limit: 10,
        ...
        bannertablesearchByApi(payloadData).then(
            async (res) => {
                console.log('res=>', res);
    ...
    const handleTableChange = async (pagination, filters, sorter) => {
        ...
        BannerModifybyapidun(offset, '', pagination.current);
        // BannerModifybyapidun(offset);
    };
    ...
    return (
        <>
            <Typography variant="h5" className="mx-2">
                <small className="text-black-50">Home</small> {'/'} <b>Banner Table</b>
            </Typography>
            <br></br>
            <MainCard>
                <Grid container spacing={2} columnSpacing={{ sm: 1, md: 3 }}>
                    <Grid item lg={6} xs={6} sm={12} md={6}>
                        <span className="main-title bg-white text-dark ">
                            <b className="brandtaitletext">Banner Table</b>
                        </span>
                    </Grid>
