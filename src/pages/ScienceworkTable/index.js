...
const ScienceworkTable = () => {
    // const conponentPDF = useRef();
    const [placement, SetPlacement] = useState('bottomRight');
    const [ScienceworkTableData, setScienceworkTableData] = useState([]);
    ...
    const handlePDF = () => {
        try {
            ...
            const tdata = ScienceworkTableData.map((elt) => [elt.batmyalable, elt.papername, elt.batmyadate]);
    ...
    //             setScienceworkTableData(res.data.data);
    //             setloading(false);
    //         },
    //         (err) => {
    ...
    //                             }
    //                         });
    //                         setScienceworkTableData(newData);
    ...
    return (
        <>
            <Typography variant="h5" className="mx-2">
                <small className="text-black-50">Home</small> {'/'} <b>Sciencework Table</b>
            </Typography>
            <br></br>
            <MainCard>
                <Grid container spacing={2} columnSpacing={{ sm: 1, md: 3 }}>
                    <Grid item lg={6} xs={6} sm={12} md={6}>
                        <span className="main-title bg-white text-dark ">
                            <b className="brandtaitletext">Sciencework Table</b>
                        </span>
                    </Grid>
                        ...
                        <Grid item lg={12} xs={12} sm={12} md={12}>
                            <div className="table-responsive">
                                <Table
                                    ...
                                    columns={columns}
                                    dataSource={ScienceworkTableData}
                                    size="small"
                                    id="excel"
                                    // bordered
...
export default ScienceworkTable;
