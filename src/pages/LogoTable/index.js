...
const LogoTable = () => {
    ...
    const [LogoTableData, setLogoTableData] = useState([]);
    ...
    const handlePDF = () => {
        try {
            ...
            const tdata = LogoTableData.map((elt) => [elt.batmyalable, elt.papername, elt.batmyadate]);
    ...
    //             setLogoTableData(res.data.data);
    //             setloading(false);
    //         },
    //         (err) => {
    ...
    return (
        <>
            <Typography variant="h5" className="mx-2">
                <small className="text-black-50">Home</small> {'/'} <b>Logo Table</b>
            </Typography>
            <br></br>
            <MainCard>
                <Grid container spacing={2} columnSpacing={{ sm: 1, md: 3 }}>
                    <Grid item lg={6} xs={6} sm={12} md={6}>
                        <span className="main-title bg-white text-dark ">
                            <b className="brandtaitletext">Logo Table</b>
                        </span>
                    </Grid>
